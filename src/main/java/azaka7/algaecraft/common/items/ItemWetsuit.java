...
public class ItemWetsuit extends ItemArmor {
    ...
    public boolean getIsRepairable(ItemStack par1ItemStack, ItemStack par2ItemStack)
	{
		if(ACItems.itemWetsuit == par1ItemStack.getItem()){
			return (ACItems.itemNeopreneTextileG.getItem() == par2ItemStack.getItem() && ACItems.itemNeopreneTextileG.getItemDamage() == par2ItemStack.getItemDamage()) || super.getIsRepairable(par1ItemStack,par2ItemStack) ;
		}
		else{
