...
public class GenLayerAC extends GenLayer
{
    ...
    public static GenLayer[] initializeAllBiomeGenerators(long par0, WorldType par2WorldType)
    {
        ...
        GenLayer expandPreOcean = GenLayerZoom.magnify(4L, genlayeraddisland, 1);
        
        GenLayerAddMushroomIsland genlayeraddmushroomisland = new GenLayerAddMushroomIsland(5L, expandPreOcean);
        
        GenLayerOceanModded genlayerocean = new GenLayerOceanModded(4L, genlayeraddmushroomisland);
        
        
        //GenLayerDeepOcean genlayerdeepocean = new GenLayerDeepOcean(4L, genlayeraddmushroomisland);
        GenLayer genlayer2 = GenLayerZoom.magnify(1000L, genlayerocean, 0);
        byte b0 = 4;
        ...
        for (int j = 0; j < b0; ++j)
        {
            ...
            if (j == 1)
            {
                object = new GenLayerShoreAC(1000L, (GenLayer)object);
            }
        }
